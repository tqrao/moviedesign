...
<div class="container met-head">
    ...
    <div class="row">
        <div class="col-xs-6 col-sm-6 logo">
            <ul class="list-none">
                <li><a href="#" class="met-logo"><img src="../image/login/login_logo.jpg"/></a></li>
                <li>用户注销</li>
...
<div class="register_index met-member">
    <div class="container">
        <form class="form-register met-form" method="post" action="canceluser">
            ...
            <button class="btn btn-lg btn-primary btn-block" type="submit">确认注销？</button>
