...
<body>
<form class="form-inline definewidth m20" action="orderQuery.jsp?kd=<%=request.getParameter("kd")%>" method="get">
	<font color="#000000"><strong style="font-size: 16px">关键字：</strong></font>
	<input type="text" name="kd" size="16px" id="kd" class="abc input-default" required placeholder="请输入关键字">&nbsp;&nbsp;
