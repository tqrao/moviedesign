...
<body>
<form class="form-inline definewidth m20" action="commentQuery.jsp?kd=<%=request.getParameter("kd")%>" method="get">
     <font color="#777777" ><strong>关键字：</strong></font>
    <input type="text" name="kd" id="kd" class="abc input-default" required placeholder="请输入关键字" >&nbsp;&nbsp;
